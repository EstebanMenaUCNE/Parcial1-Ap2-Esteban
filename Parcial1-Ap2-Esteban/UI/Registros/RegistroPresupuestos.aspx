<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroPresupuestos.aspx.cs" Inherits="Parcial1_Ap2_Esteban.UI.Registros.RegistroPresupuestos" %>
...
<body>
    ...
    <nav>
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link disabled" href="../Consultas/ConsultaPresupuestos.aspx">Consulta</a>
            </li>
        </ul>
    </nav>
