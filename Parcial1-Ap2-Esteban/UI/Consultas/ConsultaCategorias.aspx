<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaCategorias.aspx.cs" Inherits="Parcial1_Ap2_Esteban.UI.Consultas.ConsultaCategorias" %>
...
<body>
    <header>
        <div class="jumbotron bg-success">
            <h1 class="display-3" style="color: white;">Categorias</h1>
        </div>
    </header>
    ...
    <nav>
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link disabled" href="../Registros/RegistroCategorias.aspx">Registro</a>
            </li>
            <li class="nav-item">
            ...
            <div class="modal" id="ModalConfirmacionModificar">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>¿Seguro que desea ir al registro de categorias para modificar esta categoría?</p>
                        </div>
                        <div class="modal-footer">
